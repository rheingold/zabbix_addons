...
class WidgetForm extends CWidgetForm {
	...
	/**
	 * Color set names for dropdown
	 * Keys match JavaScript _color_sets object keys (0-30)
	 * Color values are defined in widget.edit.js.php
	 */
	private const COLOR_SET_NAMES = [
		0 => 'CPU',
		1 => 'CPU 2',
		2 => 'RAM',
		3 => 'Storage / DB',
		...
		14 => 'Rainbow Inverse',
		15 => 'Red Gradient',
		16 => 'Dark Red Gradient',
		17 => 'Light Red Gradient',
		18 => 'Pink Gradient',
		19 => 'Dark Green Gradient',
		20 => 'Green Gradient',
		21 => 'Light Green Gradient',
		22 => 'Dark Blue Gradient',
		23 => 'Blue Gradient',
		24 => 'Light Blue Gradient',
		25 => 'Yellow Gradient',
		26 => 'Orange Gradient',
		27 => 'Violet Gradient',
		28 => 'Purple Gradient',
		...
		return $this
			...
			->addField(
				(new CWidgetFieldSelect('color_set', _('Color set'), 
					[-1 => _('— Select color set —')] + self::COLOR_SET_NAMES
				))
					->setDefault(-1)
			)
			->addField(
